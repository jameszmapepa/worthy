...
// CommitCountSince derives the total from the rel="last" page of a per_page=1
// listing — the Link-header count trick.
...
// With no Link header the count is the length of the returned page (0 or 1).
...
// SearchIssueCount returns the total_count envelope field and forwards the query.
